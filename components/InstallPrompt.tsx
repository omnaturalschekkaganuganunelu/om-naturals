...
import { X, Download, Smartphone, Monitor, Zap, Package } from 'lucide-react';
...
export default function InstallPrompt() {
  ...
  return (
    <div className="fixed bottom-20 md:bottom-6 left-4 right-4 md:left-auto md:right-6 md:w-[360px] z-[300] animate-fade-in-up">
      <div className="bg-white rounded-3xl shadow-2xl border border-amber-100 overflow-hidden">
        ...
        <div className="px-5 py-4 space-y-2.5">
          ...
          <p className="text-[11px] text-gray-400 font-medium text-center leading-snug">
            Add to your home screen for the fastest experience. No app store needed!
          </p>
          ...
          <div className="flex gap-2 pt-1">
            ...
            <button
              ...
              disabled={installing}
              className="flex-1 flex items-center justify-center gap-1.5 py-2.5 bg-gradient-to-r from-amber-700 to-amber-900 text-white text-xs font-black rounded-2xl shadow-md hover:shadow-amber-500/30 hover:shadow-lg transition-all active:scale-95 disabled:opacity-70"
            >
              {installing ? (
