...
async function main() {
  ...
  if (existingPoojaCat) {
    ...
    await prisma.category.update({
      ...
      data: {
        ...
        image: 'https://res.cloudinary.com/dftcaaum2/image/upload/v1782238201/sbhk9kdf0n9azfhxahmz.jpg',
  ...
  const categoryColdPressed = await prisma.category.upsert({
    ...
    update: {
      ...
      image: 'https://res.cloudinary.com/dftcaaum2/image/upload/v1782238199/ovnuctgrmzmdgv9krdmv.jpg',
  ...
  const rawProducts = [
    // --- PEANUT / GROUNDNUT OILS (వేరుశనగ నూనె) ---
    {
      ...
      images: ['https://res.cloudinary.com/dftcaaum2/image/upload/v1782238180/cojbx1woteneyhoumhv5.jpg'],
    ...
    // --- COCONUT OILS (కొబ్బరి నూనె) ---
    {
      ...
      images: ['https://res.cloudinary.com/dftcaaum2/image/upload/v1782238178/gkpir09dnxp5mxpqes2j.jpg'],
    ...
    // --- BADAM / ALMOND OILS (బాదం నూనె) ---
    {
      ...
      images: ['https://res.cloudinary.com/dftcaaum2/image/upload/v1782238177/nnenzvc66v5ozyhiytfp.jpg'],
    ...
    // --- MUSTARD OILS (ఆవ నూనె) ---
    {
      ...
      images: ['https://res.cloudinary.com/dftcaaum2/image/upload/v1782238181/vljsmlizd3a1hunt1cs6.jpg'],
    ...
    // --- SESAME / NUVVULA OILS (నువ్వుల నూనె) ---
    {
      ...
      images: ['https://res.cloudinary.com/dftcaaum2/image/upload/v1782238188/anxys6btekuo9frfqjhc.jpg'],
    ...
    // --- SUNFLOWER OILS (సూర్యకాంతి నూనె) ---
    {
      ...
      images: ['https://res.cloudinary.com/dftcaaum2/image/upload/v1782238192/r7l4zdvnldxnyh1bl19g.jpg'],
    ...
    // --- SAFFLOWER OILS (కుసుమ నూనె) ---
    {
      ...
      images: ['https://res.cloudinary.com/dftcaaum2/image/upload/v1782238191/yxruvtuczqn1uc3xh3qu.jpg'],
    ...
    // --- RICE BRAN OILS (వరి తవుడు నూనె) ---
    {
      ...
      images: ['https://res.cloudinary.com/dftcaaum2/image/upload/v1782238190/skx6wfnrdw3kgt0dnmp4.jpg'],
    ...
    // --- OLIVE OILS (ఆలివ్ నూనె) ---
    {
      ...
      images: ['https://res.cloudinary.com/dftcaaum2/image/upload/v1782238182/bxpwvttnsl4wzfboisnm.jpg'],
    ...
    // --- SOYABEAN OILS (సోయాబీన్ నూనె) ---
    {
      ...
      images: ['https://res.cloudinary.com/dftcaaum2/image/upload/v1782238192/r7l4zdvnldxnyh1bl19g.jpg'], // fallback sunflower
