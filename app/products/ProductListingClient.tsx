...
function ProductListingContent({ initialProducts, initialCategories }: ProductListingClientProps) {
  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-3 sm:px-8 lg:px-12 py-6 sm:py-8 flex-1">
      ...
      {/* Page Heading */}
      <div className="mb-8">
        <h1 className="text-xl sm:text-3xl font-extrabold text-amber-955 font-heading">
          {categoryLabel}
        </h1>
        {search && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-8 items-start">
        ...
        <aside className="hidden lg:flex flex-col bg-white border border-amber-100/80 rounded-2xl p-5 shadow-sm space-y-6 sticky top-24 max-h-[calc(100vh-120px)] overflow-y-auto no-scrollbar">
          <div className="flex justify-between items-center border-b border-amber-50 pb-3">
            <h3 className="font-bold text-sm text-amber-955 flex items-center gap-1.5">
              <Filter size={15} />
              {t('products_filters')}
            </h3>
            <button
          ...
          <div className="space-y-2">
            <label htmlFor="products-keyword-search" className="text-xs font-bold text-amber-955 block">
          ...
          {/* Category Pills */}
          <div className="space-y-2">
            <label className="text-xs font-bold text-amber-955 block">
              {t('products_category')}
            </label>
          ...
          <div className="space-y-3">
            <label htmlFor="products-price-range" className="text-xs font-bold text-amber-955 block">
          ...
          {mobileFiltersOpen && (
            <div className="bg-white border border-amber-100 rounded-2xl p-4 space-y-4 shadow-sm lg:hidden animate-fade-in-up">
              <div className="flex justify-between items-center border-b border-amber-50 pb-2">
                <span className="text-xs font-bold text-amber-955">{t('products_filters')}</span>
